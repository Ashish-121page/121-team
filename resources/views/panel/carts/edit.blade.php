...
*/
$breadcrumb_arr = [
    ['name'=>'Edit Cart', 'url'=> "javascript:void(0);", 'class' => '']
]
@endphp
            ...
            <div class="row align-items-end">
                <div class="col-lg-8">
                    <div class="page-header-title">
                        ...
                        <div class="d-inline">
                            <h5>Edit Cart</h5>
                            <span>Update a record for Cart</span>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
            ...
            <div class="col-md-8 mx-auto">
               ...
               @include('backend.include.message')
                ...
                <div class="card ">
                    ...
                    <div class="card-body">
                        <form action="{{ route('panel.carts.update',$cart->id) }}" method="post" enctype="multipart/form-data" id="CartForm">
                            @csrf
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select required name="user_id" id="user_id" class="form-control select2">
                                            ...
                                            @foreach(App\User::all()  as $option)
                                                <option value="{{ $option->id }}" {{ $cart->user_id  ==  $option->id ? 'selected' : ''}}>{{  $option->name ?? ''}}</option> 
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select required name="user_shop_id" id="user_shop_id" class="form-control select2">
                                            ...
                                            @foreach(App\Models\UserShop::all()  as $option)
                                                <option value="{{ $option->id }}" {{ $cart->user_shop_id  ==  $option->id ? 'selected' : ''}}>{{  $option->name ?? ''}}</option> 
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select required name="product_id" id="product_id" class="form-control select2">
                                            ...
                                            @foreach(App\Models\Product::all()  as $option)
                                                <option value="{{ $option->id }}" {{ $cart->product_id  ==  $option->id ? 'selected' : ''}}>{{  $option->name ?? ''}}</option> 
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select required name="user_shop_item_id" id="user_shop_item_id" class="form-control select2">
                                            ...
                                            @foreach(App\Models\UserShopItem::all()  as $option)
                                                <option value="{{ $option->id }}" {{ $cart->user_shop_item_id  ==  $option->id ? 'selected' : ''}}>{{  $option->name ?? ''}}</option> 
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-12"> 
                                    <div class="form-group {{ $errors->has('qty') ? 'has-error' : ''}}">
                                        ...
                                        <input required   class="form-control" name="qty" type="number" id="qty" value="{{$cart->qty }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-12"> 
                                    <div class="form-group {{ $errors->has('price') ? 'has-error' : ''}}">
                                        ...
                                        <input required   class="form-control" name="price" type="number" id="price" value="{{$cart->price }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-12"> 
                                    <div class="form-group {{ $errors->has('total') ? 'has-error' : ''}}">
                                        ...
                                        <input required   class="form-control" name="total" type="number" id="total" value="{{$cart->total }}">
                                    </div>
                                </div>
