...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-12">
                <div class="row">
                    <div class="col-12 d-flex align-items-center  justify-content-between " style="border-bottom: 1px solid #ccc">
    ...
    <div id="searchview_modal">
        ...
        <div class="modal-content">
            ...
            <iframe src="{{ route('panel.user_shop_items.create',['type'=>'direct','type_ide'=>encrypt(auth()->id()),'assetvault'=>'true']) }}" frameborder="0" style="height: 100vh;width: 100vw" id="myframe" class="d-none"></iframe>

            <iframe src="{{ route('panel.products.edit',[492,'type' => encrypt('editmainksku')]) }}" frameborder="0" style="height: 100vh;width: 100vw" id="myframe2" class="d-none"></iframe>
