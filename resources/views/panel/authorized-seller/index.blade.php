 ...
 */
    ...
    <div class="container-fluid">
            ...
            <div class="row align-items-end">
                <div class="col-lg-8">
                    <div class="page-header-title">
                        ...
                        <div class="d-inline">
                            <h5>{{ getBrandRecordByBrandId(request()->get('id'))->name ?? '' }}</h5>
                            {{-- <span>List of @if($seller == 0) Seller Requests @else Authorized Seller @endif</span> --}}
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            <h3>@if($seller == 0) Seller Requests @else Authorized Seller @endif</h3>
                            <div class="d-flex justicy-content-right">
                                ...
                                {{-- <a href="javascript:void(0)" class="btn btn-icon btn-sm btn-outline-primary" data-target="#addSeller" data-toggle="modal" title="Add New Seller"><i class="fa fa-plus" aria-hidden="true"></i></a> --}}
                            </div>
                        </div>
                        <div id="ajax-container">
                            @include('panel.authorized-seller.load')
                        </div>
                    </div>
                </div>
            </div>
     ...
     @include('panel.authorized-seller.modal',['brand_id'=>request()->get('id')])
    <!-- push external js -->
    @push('script')
