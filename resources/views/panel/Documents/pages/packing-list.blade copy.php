...
@section('content')
    ...
    @push('head')
        <style>
            ...
            .maintabel th:nth-child(-n+4),
            .maintabel td:nth-child(-n+4) {
                position: sticky;
                left: 0;
                ...
                <div class="card">
                    <div class="card-body">
                        <img src="{{ asset(getShopProductImage($ProductRecord->id)->path ?? asset('frontend/assets/img/placeholder.png')) }}"
                            class="img-fluid my-2" style="height: 250px;width: 100%;object-fit: contain;" alt="">
                        <span>
                            <b>Model code: </b> <br> {{ $ProductRecord->model_code ?? '' }}
                            <p>
                                @php
                                    $rec = [];
                                @endphp
