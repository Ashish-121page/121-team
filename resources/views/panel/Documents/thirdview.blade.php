    ...
    <div class="container" style="max-width:1350px !important;">
      ...
      <div class="row">
        ...
        <div class="col lg-6 col-md-5 mt-5" style=" margin-left:12rem;">
          <div class="two" style="display: flex;align-items: center;justify-content: flex-end; margin-left:15rem; ">
            ...
            <div class="dropdown">
              ...
              {{-- <!-- <ul class="dropdown-menu">
                ...
                <li>
                  <a class="dropdown-item" href="{{ route('panel.products.create') }}?action=nonbranded&bulk_product">Bulk
                    - by Excel</a>
                </li>
              </ul> --> --}}
                ...
                <div class="d-flex justify-content-end mb-3">
                    ...
                    <div class="d-flex">
                        <div class="d-flex">
                            ...
                            {{-- Main search --}}
                              {{-- <input type="text" placeholder="Quick Search : Name, Model Code, Keywords" id="searchValue" name="search" style="width: 350px !important;" value="{{ request()->get('search') }}"  class="form-control"> --}}
                            {{-- Main search end--}}
  ...
  <form method="get" action="{{ route('panel.bulk.product.bulk-export',auth()->id()) }}" id="products_exportform">
      <input type="hidden" name="products" id="products_export" value="">
        ...
        {{-- <div class="row">
          ...
          <div class="col lg-6 col-md-5 d-flex justify-content-between align-items-center mt-5">
            ...
            <div class=" mx-1">
              <input type="text" class="form-control" id="search_buyer" name="search" placeholder="Buyer Search" value="">
            </div>
            <!-- <div class="input-group border rounded">
                <input type="text" id="quicktitle" value="" name="title" class="form-control border-0" placeholder="Search Buyer name or..">
                <button type="submit" class="input-group-text bg-white border-0" id="searchsubmit"><i class="uil uil-search"></i></button>
    ...
    <script>
      ...
      document.getElementById('check_all').addEventListener('change', function() {
          if (this.checked) {
              window.location.href = "{{ route('panel.Documents.fourthview') }}";
          }
      });
