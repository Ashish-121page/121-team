            ...
            <div class="col-lg-12 mt-3">
                ...
                <div class="mt-5">
                    ...
                    <div class="row mt-3 justify-content-between ">
                        <div class="col-2">
                            <input type="text" class="form-control" id="search_buyer" name="search"
                                placeholder="Buyer Search">
                        </div>
                        <!-- Filter options -->
    ...
    <script>
        $(document).ready(function() {
            $("#jwhdssu").click(function(e) {
                ...
                var msg =
                    "<div class='dropdown w-100'><h5></h5><select class='form-select' id='mybro' aria-label='Default select example'><option selected>Buyer name</option><option value='1'>One</option><option value='2'>Two</option><option value='3'>Three</option></select></div>";
                $.confirm({
                    draggable: true,
                    title: ' Buyer Search',
                    content: msg,
                        ...
                        tryAgain: {
                            ...
                            action: function() {
                                ...
                                window.location.href =
                                    "{{ route('panel.Documents.secondview') }}";
                            }
                        },
                        close: function() {
