            ...
            <div class="col-md-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div id="fromTextForm">
                            <form action="/generate-image" method="post" id="textForm">
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <br>
                                    <select name="style_preferences" class="from-control">
                                ...
                                <div class="form-group">
                                    ...
                                    <br>
                                    <select name="color_scheme" class="from-control" >
                                        <option selected>-- Select --</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="colorPickerButton">
                                        <div class="dropdown-container">
                                            ...
                                            @foreach ($colors['primary'] as $colorName => $colorValue)
                                        ...
                                        <div class="dropdown-container">
                                            ...
                                            @foreach ($colors['secondary'] as $colorName => $colorValue)
                                                <a href="#" class="color-btn" data-color="{{ $colorValue }}"
                                                    data-name="{{ $colorName }}"
                                                    style="background-color:{{ $colorValue }}; border-radius:50px;color:{{ $colorValue }};"></a>
                                            @endforeach
                                        ...
                                        <div class="dropdown-container">
                                            ...
                                            @foreach ($colors['tertiary'] as $colorName => $colorValue)
                                                <a href="#" class="color-btn" data-color="{{ $colorValue }}"
                                                    data-name="{{ $colorName }}"
                                                    style="background-color:{{ $colorValue }}; border-radius:50px;color:{{ $colorValue }};"></a>
                                            @endforeach
                                        ...
                                        <div class="dropdown-container">
                                            ...
                                            @foreach ($colors['neutral'] as $colorName => $colorValue)
                                                <a href="#" class="color-btn" data-color="{{ $colorValue }}"
                                                    data-name="{{ $colorName }}"
                                                    style="background-color:{{ $colorValue }}; border-radius:50px;color:{{ $colorValue }};"></a>
                                            @endforeach
                                        ...
                                        <div class="dropdown-container">
                                            ...
                                            @foreach ($colors['warm'] as $colorName => $colorValue)
                                                <a href="#" class="color-btn" data-color="{{ $colorValue }}"
                                                    data-name="{{ $colorName }}"
                                                    style="background-color:{{ $colorValue }}; border-radius:50px;color:{{ $colorValue }};"></a>
                                            @endforeach
                                        ...
                                        <div class="dropdown-container">
                                            ...
                                            @foreach ($colors['cool'] as $colorName => $colorValue)
                                                <a href="#" class="color-btn" data-color="{{ $colorValue }}"
                                                    data-name="{{ $colorName }}"
                                                    style="background-color:{{ $colorValue }}; border-radius:50px;color:{{ $colorValue }};"></a>
                                            @endforeach
                                        ...
                                        <div class="dropdown-container">
                                            ...
                                            @foreach ($colors['metallic'] as $colorName => $colorValue)
                                                <a href="#" class="color-btn" data-color="{{ $colorValue }}"
                                                    data-name="{{ $colorName }}"
                                                    style="background-color:{{ $colorValue }}; border-radius:50px;color:{{ $colorValue }};"></a>
                                            @endforeach
                                        ...
                                        <div class="dropdown-container">
                                            ...
                                            @foreach ($colors['pastel'] as $colorName => $colorValue)
                                                <a href="#" class="color-btn" data-color="{{ $colorValue }}"
                                                    data-name="{{ $colorName }}"
                                                    style="background-color:{{ $colorValue }}; border-radius:50px;color:{{ $colorValue }};"></a>
                                            @endforeach
                                ...
                                <div class="form-group">
                                    ...
                                    <br>
                                    <select name="materials" class="from-control" >
                                        <option selected>-- Select --</option>
                        ...
                        <div id="fromImageForm" style="display: none;">
                            <form action="/generate-image-from-image" method="post" id="ImageForm"
                                ...
                                <div class="form-group">
                                    <label for="text">How to tweak the image:</label>
                                ...
                                <div class="cent">
                                    <button type="button" class="btn btn-primary" style="border-radius: 15px"
                                        id="generateImagebyImage">Generate Image</button>
                                </div>
                            </form>
                        </div>
                ...
                <div class="card ">
                    ...
                    <div class="card-body">
                        ...
                        <div id="imageContainer" class="mt-4"
                            ...
                            <div id="placeholder"
                                style="height:450px; width: 450px; border: 2px dashed #000; display: flex;align-items: center; justify-content: center;margin: auto">
                    ...
                    <div class="card-body">
                        <div class="image-container">
                            @if (session('imagePaths'))
                                @foreach (session('imagePaths') as $imagePath)
