                            ...
                            <div class="col-12">
                                <div class="row">
                                    ...
                                    <div class="col-10">
                                        <div class="content">
                                            <h5>Export data </h5>
                                            <span>Information will be downloaded as per <a href="{{ asset('instructions/instructions.pdf') }}" download="instructions.pdf" class="btn-link text-primary" >Template</a>
                                                - All Details. Change
                                                template.</span>
