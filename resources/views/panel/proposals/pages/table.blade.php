                                ...
                                <td>
                                    ...
                                    @if ($proposal->relate_to == $proposal->user_shop_id || $proposal->relate_to == "" || $proposal->user_id == auth()->id())                                        
                                        ...
                                        <div class="d-flex float-end justify-content-between"> 
                                            ...
                                            <a class="btn btn-transparent w-fit" href="{{ inject_subdomain('proposal/picked/'.$proposal->id.'/'.$user_key, $slug, false, false)}}?type=send" target="_blank" style="text-decoration: none; margin-bottom: 10px; color:primary; padding:4px 10px!important;">
                                            ...
                                            <a class="btn-link text-primary" href="{{ inject_subdomain('proposal/edit/'.$proposal->id.'/'.$user_key, $slug, false, false)}}?margin={{$proposal->margin ?? 10}}" target="_blank" style="text-decoration: underline; padding:4px 10px!important;">
                                                ...
                                                @if ($proposal->status == 1)
                                                    @if ($product_count != 0)                                               
                                                        <button class="btn-link text-primary copybtn mx-3"  value="{{inject_subdomain('shop/proposal/'.$proposal->slug, $slug) }}" style="text-decoration: underline; border:none; margin-bottom:22px">
