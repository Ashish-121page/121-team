                ...
                <div class="card ">
                    <div class="card-body">
                        <ul class="nav nav-pills custom-pills mb-3" id="pills-tab" role="tablist">
                            ...
                            <li class="nav-item ">
                                <a data-active="shop-details" class="mr-2 active-swicher text-white pills-btn btn @if(request()->has('active') && request()->get('active') == "shop-details") active  @endif" id="pills-general-tab" data-toggle="pill" href="#last-month" role="tab" aria-controls="pills-general" aria-selected="false">{{ __('MyPage Access')}}</a>
                            </li>
                            ...
                            <li class="nav-item ">
                                <a data-active="page-feature" class="mr-2 active-swicher text-white pills-btn btn @if(request()->has('active') && request()->get('active') == "page-feature") active  @endif" id="pills-general-tab" data-toggle="pill" href="#page-feature" role="tab" aria-controls="pills-general" aria-selected="false">{{ __('My Page Feature')}}</a>
                            </li>
                            ...
                            <div class="tab-pane fade @if(request()->has('active') && request()->get('active') == "about-section") active show @endif" id="about-section" role="tabpanel" aria-labelledby="pills-general-tab">
                                <div class="row">
                                    <div class="col-lg-8">
                                        ...
                                        {{-- Testimonial Form --}}
                                        <h6 class="my-3">Testimonials Section</h6>
                                        <form action="{{ route('panel.user_shops.testimonial') }}" method="post" enctype="multipart/form-data">
                                            @csrf
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12 col-12 d-none">
                                                    <div class="form-group">
                                                        ...
                                                        <span class="text-dark">Number and country code should'nt contain "+" <span>(Ex : 91XXXXXXXXXX)</span>
                                                        </span>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12"><h6 class="my-3">Meta Info</h6></div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="meta_title" class="control-label">Meta Title</label>
                                                        <input type="text" class="form-control" name="meta_title" value="{{ $user_shop->meta_title }}">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="meta_keywords" class="control-label">Meta Keyword</label>
                                                        <input type="text" class="form-control" name="meta_keywords" value="{{ $user_shop->meta_keywords }}">
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label for="meta_description" class="control-label">Meta Description</label>
                                                        <textarea name="meta_description" class="form-control" id="" cols="30" rows="3">{{ $user_shop->meta_description }}</textarea>
                                                    </div>
                                                </div>
                                        ...
                                        <form action="{{ route('panel.user_shops.address.update', $user_shop->id) }}" method="post" id="UserShopForm" class="row">
                                            ...
                                            {{-- <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="number" name="address[gst_number]" value="{{ $shop_address['gst_number'] ?? old('gst_number') }}" placeholder="Enter GST Number">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="">Entity Name</label>
                                                    <input class="form-control" type="text" name="address[entity_name]" value="{{ $shop_address['entity_name'] ?? old('entity_name') }}" placeholder="Enter Entity Name">
                                                </div> 
                                            </div> --}}
                                            <div class="col-12">
                                                <button type="submit" class="btn btn-primary">Update</button>
                                                    ...
                                                    <div class="m-1 p-2 border rounded">
                                                        <div class="mb-2">
                                                              <div class="d-flex align-items-center justify-content-between">
                                                                <h6 class="m-0 p-0">{{ $address->type == 0 ? "Home" : "Office" }} Address:</h6>
                                                                <div>
