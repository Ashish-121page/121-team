 ...
 */
$breadcrumb_arr = [
    ['name'=>'Add Access Code', 'url'=> "javascript:void(0);", 'class' => '']
]
@endphp
            ...
            <div class="row align-items-end">
                <div class="col-lg-8">
                    <div class="page-header-title">
                        ...
                        <div class="d-inline">
                            <h5>Add Access Code</h5>
                            <span>Create a record for Access Code</span>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
            ...
            <div class="col-md-8 mx-auto">
               ...
               @include('backend.include.message')
                ...
                <div class="card ">
                    ...
                    <div class="card-body">
                        <form action="{{ route('panel.access_codes.store') }}" method="post" enctype="multipart/form-data" id="AccessCodeForm">
                            @csrf
                            ...
                            <div class="row">                           
                                <div class="col-md-4 col-12"> 
                                    <div class="form-group {{ $errors->has('code') ? 'has-error' : ''}}">
                                        ...
                                        <input required  class="form-control" name="code" type="text" id="code" value="{{old('code')}}" placeholder="Enter Code" >
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select required name="creator_id" id="creator_id" class="form-control select2">
                                            ...
                                            @foreach(App\User::all()  as $option)
                                                <option value="{{ $option->id }}" {{  old('creator_id') == $option->id ? 'Selected' : '' }}>{{  $option->name ?? ''}}</option> 
                                            @endforeach
                                        </select>
                                    </div>
                                </div> --}}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="redeemed_user_id" id="redeemed_user_id" class="form-control select2">
                                            ...
                                            @foreach(UserList()  as $option)
                                                <option value="{{ $option->id }}" {{  old('redeemed_user_id') == $option->id ? 'Selected' : '' }}>{{  $option->name ?? ''}}</option> 
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4 col-12"> 
                                    <div class="form-group {{ $errors->has('redeemed_at') ? 'has-error' : ''}}">
                                        ...
                                        <input  class="form-control" name="redeemed_at" type="datetime-local" id="redeemed_at" value="{{old('redeemed_at')}}" placeholder="Enter Redeemed At" >
                                    </div>
                                </div>
