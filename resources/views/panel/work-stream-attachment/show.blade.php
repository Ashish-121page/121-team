...
@php
$breadcrumb_arr = [
    ['name'=>'View Workstream Attachment', 'url'=> "javascript:void(0);", 'class' => '']
]
@endphp
            ...
            <div class="row align-items-end">
                <div class="col-lg-8">
                    <div class="page-header-title">
                        ...
                        <div class="d-inline">
                            <h5>{{ __('View Workstream Attachment')}}</h5>
                            <span>{{ __('View a record for Workstream Attachment')}}</span>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
