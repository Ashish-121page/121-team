            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <p>Fill the basic details of the new custom input</p>
                        </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="attr_name" id="attr_name" class="form-control" placeholder="Enter Custom Input Name" required autofocus="true" />
                                        </div>
