    ...
    <div class="row mb-3">
        <div class="col-12">
            <div class="d-flex justify-content-between">
                ...
                <div class="icons">
                    {{-- <a href="{{ url('/add-details') }}"  target="_blank">
                        <button class="btn btn-icon btn-outline-success" title="Add New Custom Input" >
                            <i class="fas fa-plus-circle"></i>
                        </button>
                    </a> --}}
                    <button class="btn btn-icon btn-outline-success" type="button" data-toggle="modal" data-target="#customFieldModal" title="Add New Custom Input" id="showDetailsBtn">
                        <i class="fas fa-plus-circle"></i>
                    </button>
                </div>
            </div>
                    ...
                    <tbody>
                        @forelse ($custom_fields as $field)
                            <tr>
                                ...
                                <td>{{ $field['text'] }}</td>
                                <td>
                                    <a href="#download" id="editCust" class="btn btn-outline-primary editCust" data-custid="{{ $field['id'] }}"  data-custname="{{ $field['text'] }}" data-values="{{ (is_array($field['value'])) ? implode(",",$field['value']) : $field['value'] }}" data-required="{{ $field['required'] ?? '' }}" data-data_type="{{ $field['data_type'] ?? '' }}" data-attr_section="{{ $field['ref_section'] ?? '1'}}" >Edit</a>
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <div>
                        <h5 class="modal-title" id="customFieldModalLabel"><b>Add Details</b></h5>
                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="attr_name" id="attr_name" class="form-control" placeholder="Enter Attribute Name" required autofocus="true" />
                                        </div>
                                    ...
                                    <div class="col-lg-12 col-md-12" id="value-field-bx" style="visibility:hidden;">
                                        <div class="col-lg-12 col-md-12">
