                    ...
                    <form action="{{ route('panel.settings.quot.setting') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="d-flex flex-wrap">
                            ...
                            <div class="form-group mx-2">
                                ...
                                <select class="form-control select2" id="entity_name" name="entity_name">
                                    @foreach ($address as $item)
                                        <option>{{ json_decode($item->details)->entity_name ?? '' }}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            {{-- PI Section Start --}}
                            <div class="form-group mx-1">
                                <label for="performa_mark" class="text-danger " >PI ID Prefix <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" name="performa_mark" id="performa_mark" placeholder="PI Mark" value="{{ $quot->performa_mark ?? '' }}">
                            </div>
                            <div class="form-group mx-2">
                                <label for="performa_index" class="text-danger ">PI ID Start <span class="text-danger">*</span></label>
                            ...
                            <div class="form-group mx-1">
                                <label for="invoice_mark" class="text-danger ">Invoice ID Prefix <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" name="invoice_mark" id="invoice_mark" placeholder="Invoice Mark" value="{{ $quot->invoice_mark ?? '' }}">
                            </div>
                            <div class="form-group mx-2">
                                <label for="invoice_index" class="text-danger ">Invoice ID Start <span class="text-danger">*</span></label>
