                ...
                <div class="card">
                            ...
                            @forelse ($categories as $category)
                                ...
                                @if($category)
                                    ...
                                    @if(($category_products_count = getProductCountViaCategoryId($category->id,request()->get('type_id'))) > 0)
                                        ...
                                        type="submit" data-category_id="{{ $category->id }}" class="categoryFilter btn filterable-btn btn-outline-info @if(request()->get('category_id') == $category->id) active @endif" data-cid="{{$category->id}}">{{$category->name}} ({{ $category_products_count }})</button>
                    ...
                    <div class="card-body">
                        ...
                        @if (request()->get('type_id') == auth()->id())
                            ...
                            <form action="{{ route('panel.user_shop_items.removebulk') }}" method="post">
                                ...
                                <div class="d-flex justify-content-end mb-3">
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div class="d-flex">
                                            ...
                                            @if (request()->get('type_id') == auth()->id())
                                                <button type="submit" name="delproduct" class="btn btn-sm btn-danger mr-2 validateMargin">Delete Products</button>
                                                <input type="submit" name="delete_all" value="Delete All Products" class="btn btn-outline-primary">
                                            @endif

                                            <input type="text" placeholder="Search Here" id="searchValue" name="search" value="{{ request()->get('search') }}"  class="form-control">
                                            ...
                                            <div class="product-card product-box">
                                                ...
                                                <div class="product-body">
                                                    ...
                                                    <div>
                                                        ...
                                                        <b>{{$scoped_product->category->name}}</b>     
