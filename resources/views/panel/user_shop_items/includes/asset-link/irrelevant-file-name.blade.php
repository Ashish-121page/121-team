...
@section('content')
    ...
    <div class="container-fluid ">
        ...
        <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
            ...
            {{-- <li class="nav-item mx-2" role="presentation">
                <button class="btn btn-link text-muted " id="pills-contact-tab" data-bs-toggle="pill"
                    data-bs-target="#pills-contact" type="button" role="tab" aria-controls="pills-contact"
                    aria-selected="false">Create SKU</button>
            </li>
            <li class="nav-item mx-2" role="presentation">
        ...
        <div class="tab-content" id="pills-tabContent">
            ...
            <div class="tab-pane fade" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab"
                ...
                <div class="">
                    <div class="col-12 d-flex justify-content-between mb-3">
                        <div class="h6">Vault: #<span>________</span> </div>
                        <div class="h6"> ______________ </div>
                        <div class="">
                            <div class="h6">Vault: #<span>________________</span></div>
                            <div class="h6">Uploaded: #<span>______</span> assets</div>
                            <div class="h6">New assets: #<span>______</span> </div>
                            <div class="h6">Invalid assets: #<span>______</span> </div>
                        </div>
                    </div>

                    <div class="col-12 mb-3">
                        <div class="h6">______ Model Code linked to existing sku: </div>
                    </div>
                    <div class="col-12 mb-3">
                    ...
                    <div class="col-12 mb-3">
                        <div class="h6">______ Model <span class="text-danger ">created</span>:</div>
                    </div>
                    <div class="col-12 mb-3">
                    ...
                    <div class="col-12 mb-3 d-flex justify-content-center">
                        <button class="btn mx-2 btn-outline-primary">Create</button>
                        {{-- <button class="btn mx-2 btn-primary">Fill Details</button> --}}
                    </div>
