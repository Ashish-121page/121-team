        ...
        <div class="">
            <div class="col-12 d-flex justify-content-between mb-3">
                <div class="row">
                    ...
                    <div class="h6 col-12 col-md-6 my-2"> File Name Irrelevant </div>
                ...
                <div class="accordion-item">
                    ...
                    <div id="collapseTwo" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                        <div class="accordion-body">
                            <div class="row">
                                @forelse ($Notavailable_skus as $filename => $Notavailable_sku)
                                    <div class="col-12 mb-3">
                                        <div class="h6">


                                            {{-- it's still a bug 'jitna products hamne abhi upload kiye hen agar last uploaded product ki length in se kam he to 2 + ho rahe hen' --}}
                                            {{-- Model Code : {{ explode('-',$Notavailable_sku)[0] }}-{{  intval(explode('-',$Notavailable_sku)[1]) + $loop->iteration }} --}}
                                            Model Code :  {{ explode('-',$Notavailable_sku)[0] }}-{{ $loop->iteration + intval(explode('-',$Notavailable_sku)[1]) }}
                                        </div>
                                    </div>
                                    <div class="col-12 mb-3">
                                        <div class="swiper">
