   ...
   <div class=" col-md-12 col-lg-12 col-sm-12  d-flex flex-wrap justify-content-between gap-1"  style="padding: 0px ;">
        ...
        @foreach ($categories as $item)
            <div class="cardbx col-12 col-sm-12 col-md-6 col-lg-4 col-xl-3 ywqgqdya product-card product-box d-flex flex-column border bg-white"  style="width: 25rem;;max-width: 25rem; min-height: 13.5rem;max-height: 15rem;">
                ...
                <div class="cardbody d-flex justify-content-around  gap-2" style="padding-bottom: 1rem; padding-top: 1rem;">
                    ...
                    @foreach ($last_Records as $last_Record)
                        <div class="col-6 col-md-4 col-lg-3 d-flex" style="height: 100px; width: 100px;object-fit: contain; padding:0px;">
                            <img src="{{ asset(getShopProductImage($last_Record->id,0)->path ?? '')  ?? ''}}"  class="img-fluid p-1" style="border-radius: 10px;height: 100%; width: 100%;aspect-ratio: 1/1;">
                        </div>
                    @endforeach
