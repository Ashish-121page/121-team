                    ...
                    <div class="col-6 custom-spacing mx-1">
                        <div class="accordion" id="accordionInternalCollection">
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="collapseInternalCollection" class="accordion-collapse collapse"
                                    data-bs-parent="">
                                    <div class="accordion-body">
                                        <code>
                                            <div class="row">
                    ...
                    <div class="col-6 custom-spacing mx-1">
                        <div class="accordion" id="accordionSample">
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="collapseSample" class="accordion-collapse collapse" data-bs-parent="">
                                    <div class="accordion-body">
                                        <code>
                                            <div class="row">
                                                <div class="col-12">
                    ...
                    <div class="col-6 custom-spacing mx-1">
                        <div class="accordion" id="accordionProduction">
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="collapseProduction" class="accordion-collapse collapse" data-bs-parent="">
                                    <div class="accordion-body">
                                        <code>
                                            <div class="row">
                                                <div class="col-12">
