...
@section('InlineScript')
    ...
    // <script>
    //     // let url = 'http://ashish.localhost/project/121.page-Laravel/121.page/shop?sort=&category_id=&searchVal_0%5B%5D=95&searchVal_0%5B%5D=98&searchVal_0%5B%5D=99';

    //     // function removeTagsfromUrl(url, tags to remove) {
    //     //     let urlObject = new URL(url);

    //     //     for ( const tag of tags to remove) {
    //     //         urlObject.searchParams.delete(tag);
    //     //     }
    //     //     return urlObject.toString();
    //     // }

    //     // document.getElementById('removeTag').add

    //     // let tagsToRemve = ['tag1', 'tag2'];

        
    //     // let newURL = removeTagsfromUrl(url, tags to remove);
