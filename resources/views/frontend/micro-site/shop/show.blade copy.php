                    ...
                    <div class="section-title ms-md-4 ">
                        ...
                        <form method="GET" id="searchForm">
                            ...
                            <div class="d-flex gap-2 flex-wrap">
                                ...
                                @if (count($colors) > 0)
                                    <div class="">
                                        <label for="selected_Cust" @if(count($colors) > 1) style="color:#6666cc;font-weight: bold" @endif> Colour @if (count($colors) > 1)  *  @endif </label>
                                ...
                                @if (count($sizes) > 0)
                                    <div class="">
                                        <label for="selected_Cust" @if(count($sizes) > 1) style="color:#6666cc;font-weight: bold" @endif> Size @if (count($sizes) > 1) * @endif </label>
                                ...
                                @if (count($materials) > 0)
                                    <div class="">
                                        <label for="selected_Cust" @if(count($materials) > 1) style="color:#6666cc;font-weight: bold" @endif> Material @if (count($materials) > 1) * @endif </label>                                                    
                                        <select name="selected_default[]" class="form-control form-select" id="selected_3">
