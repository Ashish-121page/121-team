...
<div id="animatedModal3">
    ...
    <div class="modal-content custom-spacing max-content" style="background-color:#f3f3f3; height: 50vh; width: 50%; overflow-y:hidden!important; overflow-x:hidden!important">
        <div class="row">
