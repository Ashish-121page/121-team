...
@foreach ($products as $key => $product)
    ...
    @endphp
        ...
        <div class="col-md-3 col-sm-6 col-12 mt-5 jusify-content-between card" style="font-size:2rem">
            ...
            <div class="d-flex justify-content-between mt-1 ">
                ...
                @else --}}
                    <div class="text-dark mb-0 mt-1 w-100 product_price" contenteditable="true">
                        {{ $currency_symbol }}
                        {{ $price }}
