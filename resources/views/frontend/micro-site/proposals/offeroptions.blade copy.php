                    ...
                    <div class="col-12 my-3 py-2">
                        <table class="table">
                            <tbody>
                                <tr>
                                    <td>
                                        {{-- <p>Download PDF <span>  <i class="fas fa-file-alt fa-lg"></i> :</span></p> --}}
                                        {{-- <p>Download PDF <span class="icon-container"><i class="fas fa-file-alt" style="color: #1f3251;"></i></span><span> :</span></p> --}}
                                ...
                                <tr>
                                    <td>
                                        {{-- <p>Download PPT<span class="icon-container"><i class="far fa-file-excel fa-lg" style="color: #1f3251;"></i></span><span> :</span></p> --}}
            ...
            {{-- <div class="col-12">
                <div class="d-flex justify-content-center justify-content-sm-between justify-content-md-between ">
                    <div class="col-12 my-3 py-2">
                        ...
                        align-items: center;">
                            <p>Download PDF <i class="fas fa-file-alt"></i><span> :</span></p>
                            <div class="d-flex my-3" >
                                <a href="{{ inject_subdomain('shop/proposal/'.$proposal->slug, $user_shop_record->slug) }}" class="btn btn-outline-primary mx-5">
                                    Download
                                </a>
