                    ...
                    <div class="row">
                        <div class="col-12 d-flex justify-content-between align-items-center adwas">
                            ...
                            <div class="col-1 d-md-none ">
                                <div class="filterMobile" style="margin-top: 10%;">
            ...
            <div class="row">
                ...
                <div class="col-lg-9 col-md-8 col-12 pt-2 mt-sm-0 pt-sm-0">
                    ...
                    <div class="row align-items-center">
                        <div class="col-3">
                            @if (count($currency_record) != 0)
                                <div class="container" id="selector">
                                    <select class="form-control select_box changeCurrency" id="changeCurrency" name="Currency" style="width: max-content;">
                        ...
                        <div class="col-4 ">
                            <div class="container" id="selector">
                                <select class="form-control input-lg select_box" id="productSort" name="sort" style="width: max-content">
