<!-- Modal -->
<div class="modal fade" id="sendForCatalogue" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
      ...
      <form action="{{ route('panel.seller.request.catalogue') }}" method="post" class="digit-group" data-group-name="digits" data-autosubmit="false" autocomplete="off">
          @csrf
          <input type="hidden" value="1" name="status" id="status-val">
          ...
          <div class="modal-body">
              <div class="row sent-catalogue-group mb-3">
                  <div class="col-12">
              ...
              <div class="row">
                  <div class="col-12">
                      ...
                      --}}
                      <div class="req_num" style="display: flex; mt-2">
          ...
          <div class="modal-footer">
              <button type="submit" id="accessRequestbtn" class="btn btn-primary mx-auto">Send</button>
