<div class="modal fade" id="adddetails" role="dialog" aria-labelledby="add-detailsTitle" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="add-detailsTitle">Add Details</h5>
            ...
            <div class="modal-body">
                ...
                <div id="formContainer" style="display: none; margin-top: 35px;">
                    <!-- form content here -->
