                ...
                <div class="modal-body">
                    <div class="row g-3">
                        ...
                        <div class="col-lg-6 col-md-6 col-6 mt-3">
                            ...
                            <input class="form-control" type="text" name="gst_number" id="gstNumber" value="{{ old('gst_number')  }}" placeholder="Enter GST Number">
                        </div>
                        <div class="col-lg-6 col-md-6 col-6 mt-3">
                            <label for="">Entity Name</label>
                            <input class="form-control" type="text" name="entity_name" id="entityName" value="{{ old('entity_name')   }}" placeholder="Enter Entity Name">
                        </div>                       
