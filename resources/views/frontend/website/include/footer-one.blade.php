                    ...
                    <div class="row">
                        <div class="col-lg-4 col-12 mb-0 mb-md-4 pb-0 pb-md-2">
                            ...
                            <ul class="list-unstyled social-icon foot-social-icon mb-0 mt-4">
                                ...
                                <li class="list-inline-item"><a target="_blank" href="{{ getSetting('twitter_link') }}" class="rounded">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12 col-md-12 col-12 mt-2 mt-sm-0">
                                    <ul class="list-unstyled footer-list">
                                            <li><a href="{{ route('about-one') }}" class="text-foot"><i class="uil uil-angle-right-b me-1"></i>About </a></li>
                                            {{-- <li><a href="{{ route('plan.index') }}" class="text-foot"><i class="uil uil-angle-right-b me-1"></i>Plan</a></li> --}}
                                            <li class="pb-3"><a href="{{ route('contact.index-one') }}" class="text-foot"><i class="uil uil-angle-right-b me-1"></i>Contact</a></li>
                                    </ul>
                                </div>
                            </div><!--end row-->
                        </div><!--end col-->
                        ...
                        {{-- Newsletter  hidden for new landing page --}}
                        ...
                        {{-- book demo hidden for new landing page --}}
                        {{-- <div class="col-lg-4 col-md-6 col-12 mt-4 mt-lg-0 pt-2 pt-lg-0">
