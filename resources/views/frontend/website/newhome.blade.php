...
@section('content')
                ...
                <div class="col-md-6">
                    <div class="title-heading me-lg-4 wow animate__animated animate__fadeInUp" data-wow-delay=".1s">
                        <h1 class="heading fw-bold mb-3">
                            <span class="text-primary">Central Source </span> <br> of all <span class="text-primary">your
                        ...
                        <div class="subscribe-form mt-2 py-2 text-start">
                            <form class="m-0 d-inline-block" style="text-decoration-color: white">
                                    ...
                                    <a href="{{ url('start') }}" class="btn btn-pills btn-primary" style="color: white;">
                                        Know More
    ...
    <section class="section">
        <div class="container" id="why-121" style="padding-top: 70px; margin-bottom: 0">
            <div class="row justify-content-center">
                <div class="col-12 text-center">
                    <div class="section-title mb-4 pb-2 wow animate__animated animate__fadeInUp" data-wow-delay=".1s">
                        ...
                        <div class="h1 text-primary" style="font-weight: 900;">Why 121 ?</div>
                        ...
                        <p class="text-muted para-desc mb-0 mx-auto">With 121, seamlessly handle unlimited items across any
                            product categories. <span class="text-primary fw-bold"></span> </p>
                    </div>
                </div><!--end col-->
            </div><!--end row-->
        ...
        <div class="container mt-100 mt-60" id="benefits" style="padding-top: 80px; margin-bottom: 0">
            <div class="row justify-content-center">
                <div class="col-12 text-center">
                            ...
                            <div class="d-flex features feature-primary">
                                <div class="icon text-center rounded-circle text-primary me-3 mt-2">
                                    ...
                                    <svg width="24" height="24" viewBox="0 0 100 100"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path fill="currentColor"
                                            d="M94.284 65.553L75.825 52.411a1.255 1.255 0 0 0-1.312-.093c-.424.218-.684.694-.685 1.173l.009 6.221H57.231c-.706 0-1.391.497-1.391 1.204v11.442c0 .707.685 1.194 1.391 1.194h16.774v6.27c0 .478.184.917.609 1.136s.853.182 1.242-.097l18.432-13.228c.335-.239.477-.626.477-1.038v-.002c0-.414-.144-.8-.481-1.04z" />
                                        <path fill="currentColor"
                ...
                <div class="col-md-6 mt-4 pt-2">
                    <div class="accordion" id="accordionExample">
                        ...
                        <div class="accordion-item rounded shadow mt-3 wow animate__animated animate__fadeInUp"
                            ...
                            <div id="collapseTwo" class="accordion-collapse border-0 collapse show"
                                ...
                                <div class="accordion-body text-muted">
                                    ...
                                    When that place is your folders or spreadsheets, it's too easy to make costly mistakes.
                                    121 helps you keep your data error- free and formatted in the way that you need it.
                                    <br>
                                    <b>Who benefits from Catalogue distribution tool ?</b>
                                    121 is for you if you're selling over 100 products . 121 is the only
                                    tool specially made
                                    (and priced ! ) for small to medium-sized businesses.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item rounded shadow mt-3 wow animate__animated animate__fadeInUp"
                            ...
                            <div id="collapseFour" class="accordion-collapse border-0 collapse"
                                ...
                                <div class="accordion-body text-muted">
                                    <b>121</b> helps you distribute product information anywhere online using one of two
                                    main methods:<br>
                                    1. <b>Custom Offers :</b> create and update PDF , Power point or Excel catalogs with
                                    accurate product data straight from your 121 account - no more copying and pasting.<br>
                        ...
                        <div class="accordion-item rounded shadow mt-3 wow animate__animated animate__fadeInUp"
                            ...
                            <div id="collapseThree" class="accordion-collapse border-0 collapse"
                                ...
                                <div class="accordion-body text-muted">
                                    121 offers a user-friendly and intuitive interface, eliminating the need for a developer
                                    to kickstart your usage.
                                    Our onboarding team assists you in gathering data and training your team for seamless
                                    ongoing updates. We will further be available for support as needed.
                                </div>
                            </div>
                        </div>
