            ...
            <form action="{{ route('demoform.store') }}" method="post">
                ...
                <div class="cols p3">
                    ...
                    <div class="inpbx">
                        ...
                        <input type="email" placeholder="sample@demo.com" name="email" class="my-2 form-control"
                            id="email" required>
                ...
                <div class="cols p4">
                    <div class="inpbx">
                        ...
                        <input type="date" name="gdate" id="gdate" class="my-2 form-control" required
                            min="2023-08-16">
                        <input type="time" name="gtime" id="gtime" class="my-2 form-control" min="10:30"
                            max="18:00" required>
                        <small class="fs-6">Choose Between 10:30 to 18:00</small>
                        <br>
                        <button type="submit" class="btn btn-primary submit">Submit</button>
                    </div>
                    <img src="{{ asset('storage/backend/booksession/time1.svg') }}" class="img-submit"
