...
@section('content')
    ...
    <section class="">
        <div class="hero d-flex justify-content-center">
            ...
            <form action="forms/d/e/1FAIpQLSecMyXvlfocH8rJJ0KNVA1xy9tjXVZFBW7EfdlbycdVw98Zig/formResponse" method="post">

                <!-- Hidden Section -->

                <div class="hidden_content">
                    <input type="hidden" name="entry.137550352" value="1701258692788">
                ...
                <div class="cols p1 active">
                    <div class="inpbx">
                        <div class="row">
                            ...
                            <input type="text" placeholder=". . . ." name="work1" class="my-2 form-control"
                                id="work1" required>
                        </div>
                        <div class="row mt-4">
                            <label for="refr">Reference</label>

                            <input type="text" placeholder="" name="refr" class="my-2 form-control" id="refr"
                                required>
                        </div>
                        <div class="row mt-4">
                ...
                <div class="cols p2">
                    <div class="inpbx">
                        <div class="row">
                            ...
                            <small>Date</small>
                            <input type="date" name="startdate" id="startdate" class="my-2 form-control" required
                                min="2023-08-16">
                        </div>
                        <div class="row">
                            <label for="pdate">Plan Date</label>
                            <small>Date</small>
                            <input type="date" name="pdate" id="pdate" class="my-2 form-control" required
                                min="2023-08-16">
                        </div>
                        <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <label class="form-check-label" style="width:90%;" for="highPriorityCheckbox">High
                                    Priority</label>
                            </div>
                        </div>
            ...
            <div class="controlbtn">
                <span title="Click To Previous" data-input="8" id="prev"><i class="uil-angle-up"></i></span>
    ...
    <script>
        $(document).ready(function() {
            ...
            function moveToNextField(currentField, nextField) {
                ...
                $(nextField).find('input, select').first()
