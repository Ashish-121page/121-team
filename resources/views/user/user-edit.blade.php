                    ...
                    <div class="card-body">
                        <form class="forms-sample" method="POST" action="{{ route('panel.update-user', $user->id) }}"
                            ...
                            <div class="form-group d-none">
                                <label for="role" required>{{ __('Assign Role') }}<span
                                ...
                                <div class="col-md-6">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input id="email" type="email"
                                                    ...
                                                    required value="{{ clean($user->email, 'titles') }}" required>
                                                <div class="help-block with-errors"></div>
                                        ...
                                        @if (UserRole($user->id)->name == 'User')
                                            ...
                                            <div class="form-group">
                                                <label for="phone">{{ __('Industry') }}<span
                                                        class="text-red">*</span></label>
                                                <select name="industry_id[]" class="form-control select2" id="industry_id"
                                                    multiple>
                                                    @foreach (App\Models\Category::whereCategoryTypeId(13)->whereParentId(null)->whereType(1)->get() as $item)
                                                        <option
                                                            @if ($industry) {{ in_array($item->id, $industry ?: []) ? 'selected' : '' }} @endif
                                                    ...
                                                    <div class="form-check p-0">
                                                        <label class="custom-control custom-checkbox" for="demo_given">
                                                            <input type="checkbox" class="custom-control-input"
                                                                name="demo_given"
                                                                @if ($user_shop->demo_given == 1) checked @endif
                                                                value="1" id="demo_given">
                                                            <span class="custom-control-label"
                                                                style="position: absolute;">Show carousel</span>
                                                        </label>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                @php
                                                    $draft_offers = App\Models\Proposal::where('user_id', $user->id)
                                                        ->where('status', 0)
                                                        ->pluck('id');
                                                    $blank_offers = [];
                                                ...
                                                <a href="{{ route('backend.constant-management.proposals.deleteDraft', $user->id) }}"
                                                    class="btn btn-sm btn-outline-danger delete-item"
                                                    title="Delete All Draft Offers Till Now.">
                                                    Delete Empty Offer <i class="fa fa-trash" aria-hidden="true"></i>
                                                    {{ count($blank_offers) }}
                                                </a>
                                            </div>
                                        ...
                                        @php
                                            ...
                                            $permi->managegroup = $permi->managegroup ?? 'no';
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="form-check p-0">
                                                    <label class="custom-control custom-checkbox">
                                                        <input type="checkbox" class="custom-control-input"
                                                            name="is_supplier"
                                                            @if ($user->is_supplier == 1) checked @endif value="1"
                                                            id="is_supplier">
                                                        <span class="custom-control-label"
                                                            style="position: absolute;">Enable Seller Panel</span>
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="form-check p-0">
                                                    <label class="custom-control custom-checkbox">
                                                        <input type="checkbox" class="custom-control-input"
                                                            name="is_verified"
                                                            @if ($user->is_verified == 1) checked @endif value="1"
                                                            id="is_verified">
                                                        <span class="custom-control-label"
                                                            style="position: absolute;">Verify Email</span>
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="form-check p-0">
                                                    <label class="custom-control custom-checkbox">
                                                        <input type="checkbox" class="custom-control-input"
                                                            name="ekyc_status"
                                                            @if ($user->ekyc_status == 1) checked @endif value="1"
                                                            id="ekyc_status">
                                                        <span class="custom-control-label"
                                                            style="position: absolute;">Verify KYC</span>
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <button type="submit"
                                            class="btn btn-primary form-control-right float-right">{{ __('Update') }}</button>
                                    </div>
                                </div>
                            </div>
                        </form>
