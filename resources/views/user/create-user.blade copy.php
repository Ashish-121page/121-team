        ...
        <script>
            ...
            function checkall() {
                var arr_yes = ['mycustomeryes', 'Filemanageryes', 'addandedityes', 'bulkuploadyes', 'pricegroupyes',
                    'mysupplieryes', 'managegroupyes', 'manangebrandsyes', 'offersyes', 'documentationyes'
                ];
            ...
            function decheckall() {
                var arr_no = ['mycustomerno', 'Filemanagerno', 'addandeditno', 'bulkuploadno', 'pricegroupno', 'mysupplierno',
                    'managegroupno', 'manangebrandsno', 'offersno', 'documentationsno'
                ];
            ...
            $("#userdealer").click(function(e) {
                ...
                var arr_supplier = ['mycustomerno', 'addandeditno', 'pricegroupno', 'manangebrandsno', 'bulkuploadno',
                    'managegroupno', 'documentationsno'
                ];
