        ...
        <div class="container">
            <div class="row justify-content-center mt-4">
                <div class="col-lg-8 col-md-12 text-center">
                    {{-- <img src="" class="img-fluid" alt="" style="height:40%;padding-top: 90px!important;"> --}}
                    {{-- <h4></h4> --}}
                    <div class="text-uppercase display-3">{{ getSetting('app_name') }}</div>
                    {{-- <div class="text-capitalize text-dark mb-4 error-page">Page Not Found</div> --}}
                    {{-- <p class="mx-auto text-center"><span class="text-primary fw-bold"></span></p> --}}
                    <p class="text-muted para-desc mx-auto">You dont have permission to access this page.</p>
