        ...
        <div class="container">
            <div class="row justify-content-center mt-4">
                <div class="col-lg-8 col-md-12 text-center">
                    ...
                    <div class="text-capitalize text-dark mb-4 error-page">Offer Expired</div>
                    <p class="mx-auto text-center"><span class="text-primary fw-bold">{{ getSetting('app_name') }}</span></p>
                    <p class="text-muted para-desc mx-auto">This offer has Expired, request the supplier again.</p>
