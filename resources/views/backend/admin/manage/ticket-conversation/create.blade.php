...
@php
$breadcrumb_arr = [
    ['name'=>'Add Ticket Conversation', 'url'=> "javascript:void(0);", 'class' => '']
]
@endphp
            ...
            <div class="row align-items-end">
                <div class="col-lg-8">
                    <div class="page-header-title">
                        ...
                        <div class="d-inline">
                            <h5>{{ __('Create New Ticket Conversation')}}</h5>
                            <span>{{ __('Add a new record for Ticket Conversation')}}</span>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
            ...
            <div class="col-md-8 mx-auto">
                <div class="card ">
                    <div class="card-header">
                        <h3>{{ __('Add Ticket Conversation')}}</h3>
                    </div>
                    <div class="card-body">
