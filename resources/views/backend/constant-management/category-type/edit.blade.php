                ...
                <div class="card ">
                    ...
                    <div class="card-body">
                        <form action="{{ route('panel.constant_management.category_type.update', $category_type->id) }}" method="post">
                            @csrf
                            @if (AuthRole() == 'User')
                                <input type="hidden" name="defined_by" value="1">
                            @endif
                            <div class="row">
                                    <div class="col-md-6">   
                                    ...
                                    {{-- <div class="col-md-4">   
                                        <div class="form-group {{ $errors->has('code') ? 'has-error' : ''}}">
                                            ...
                                            <input class="form-control" name="code" type="text" id="code" placeholder="code" value="" required>
                                        </div>
                                    </div> --}}
                                    ...
                                    <div class="col-md-6">   
                                        <div class="form-group {{ $errors->has('allowed_level') ? 'has-error' : ''}}">
                                            ...
                                            <select required name="allowed_level" id="allowed_level" class="form-control select2">
                                                ...
                                                <option value="1" {{ $category_type->allowed_level == 1 ? 'selected' : ''}}>{{ __('1')}}</option> 
                                                <option value="2" {{ $category_type->allowed_level == 2 ? 'selected' : ''}}>{{ __('2')}}</option>
                                                <option value="3" {{ $category_type->allowed_level == 3 ? 'selected' : ''}}>{{ __('3')}}</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-12">  
                                        <div class="form-group {{ $errors->has('remark') ? 'has-error' : ''}}">
                                            ...
                                            <textarea class="form-control" rows="5" name="remark" type="textarea" id="remark" placeholder="Enter remark here..." required>{{ isset($category_type->remark) ? $category_type->remark : ''}}</textarea>
                                            {{-- <input class="form-control" rows="5" name="remark" type="textarea" id="remark" value="" > --}}
                                        </div>
                                    </div>
